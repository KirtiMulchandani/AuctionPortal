...
?>
    ...
    <body>
        ...
        <div class="container mt-4">
            <h4 class="mb-4">Auctions Available</h4>
            <hr>
            <?php
            include "./config.php";
            ...
            $query = "SELECT * FROM `bidder` WHERE username = '$username'";
            ...
            $query = "SELECT * FROM `property` WHERE district = '$dist' AND state = '$state'";
            $result = mysqli_query($conn, $query);
            ...
            $sql = "SELECT * FROM `auction` WHERE property = '$property'";
